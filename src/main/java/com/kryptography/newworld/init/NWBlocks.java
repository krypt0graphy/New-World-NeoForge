...
public class NWBlocks {
	...
	public static final DeferredBlock<StandingSignBlock> FIR_SIGN = BLOCKS.register("fir_sign", () -> new StandingSignBlock(FirBlockSet.FIR_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN)));
	public static final DeferredBlock<WallSignBlock> FIR_WALL_SIGN = BLOCKS.register("fir_wall_sign", () -> new WallSignBlock(FirBlockSet.FIR_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN)));

	public static final DeferredBlock<CeilingHangingSignBlock> FIR_HANGING_SIGN = BLOCKS.register("fir_hanging_sign", () -> new CeilingHangingSignBlock(FirBlockSet.FIR_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN)));
	public static final DeferredBlock<WallHangingSignBlock> FIR_WALL_HANGING_SIGN = BLOCKS.register("fir_wall_hanging_sign", () -> new WallHangingSignBlock(FirBlockSet.FIR_WOOD_TYPE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN)));
