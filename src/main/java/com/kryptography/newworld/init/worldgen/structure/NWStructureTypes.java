...
public class NWStructureTypes {
    ...
    public static final RegistryObject<StructureType<BuriedBunkerFeature>> BURIED_BUNKER = STRUCTURE_TYPES.register("buried_bunker", () -> () -> BuriedBunkerFeature.CODEC.codec());
