...
public class NWBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.simpleBlock(NWBlocks.FIR_SAPLING.get(), models().cross(NWBlocks.FIR_SAPLING.getId().getPath(), blockTexture(NWBlocks.FIR_SAPLING.get())).renderType("cutout"));

        this.simpleBlockWithItem(NWBlocks.POTTED_FIR_SAPLING.get(), models().singleTexture("potted_fir_sapling", new  ResourceLocation("minecraft", "block/flower_pot_cross"), "plant", blockTexture(NWBlocks.FIR_SAPLING.get())).renderType("cutout"));

        this.simpleBlockWithItem(NWBlocks.POTTED_POINTED_DRIPSTONE.get(), models().singleTexture("potted_pointed_dripstone", new ResourceLocation("minecraft", "block/flower_pot_cross"), "plant", blockTexture(Blocks.POINTED_DRIPSTONE).withSuffix("_up_tip")).renderType("cutout"));
    ...
    private void mossSproutBlock (Block moss, boolean tint) {
        this.simpleBlock(NWBlocks.MOSS_SPROUTS.get(), models().withExistingParent(NWBlocks.MOSS_SPROUTS.getId().getPath(), "block/tinted_cross").renderType("cutout").texture("cross", blockTexture(NWBlocks.MOSS_SPROUTS.get())));
    }
