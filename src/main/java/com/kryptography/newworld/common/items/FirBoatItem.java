...
public class FirBoatItem extends Item {
    ...
    private final FirBoatEntity.Type type;
    private final boolean hasChest;

    public FirBoatItem(boolean pHasChest, FirBoatEntity.Type pType, Item.Properties pProperties) {
        super(pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                if (boat instanceof FirChestBoatEntity chestBoat) {
                    chestBoat.setVariant(this.type);
                } else if (boat instanceof FirBoatEntity) {
                    ((FirBoatEntity) boat).setVariant(this.type);
                }
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return this.hasChest ? new FirChestBoatEntity(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) :
                new FirBoatEntity(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z);
    }
}
